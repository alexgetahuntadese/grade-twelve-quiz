...

  {
    ...
    questions: [
      // Easy Questions
      {
        ...
        options: ['Proteins, lipids, carbohydrates, nucleic acids', 'Only proteins', 'Only carbohydrates', 'Only lipids'],
        correct: 'Proteins, lipids, carbohydrates, nucleic acids',
        explanation: 'The four major biomolecules are proteins, lipids, carbohydrates, and nucleic acids.',
        difficulty: 'easy'
      },
      {
        id: 'g12_biochem_easy_2',
        question: 'What is the main function of carbohydrates?',
        options: ['Energy storage and structure', 'Genetic information', 'Enzyme catalysis', 'Cell membrane'],
        correct: 'Energy storage and structure',
        explanation: 'Carbohydrates serve as energy sources and structural components.',
        difficulty: 'easy'
      },
      {
        id: 'g12_biochem_easy_3',
        question: 'What is photosynthesis?',
        options: ['Breaking down glucose', 'Converting light energy to chemical energy', 'Cellular respiration', 'Protein synthesis'],
        correct: 'Converting light energy to chemical energy',
        explanation: 'Photosynthesis converts light energy into chemical energy stored in glucose.',
        difficulty: 'easy'
      },
      {
        id: 'g12_biochem_easy_4',
        question: 'What is an enzyme?',
        options: ['Energy source', 'Biological catalyst', 'Genetic material', 'Cell membrane'],
        correct: 'Biological catalyst',
        explanation: 'Enzymes are biological catalysts that speed up chemical reactions.',
        difficulty: 'easy'
      },
      {
        id: 'g12_biochem_easy_5',
        question: 'What is acid rain caused by?',
        options: ['Oxygen pollution', 'Sulfur and nitrogen oxides', 'Carbon dioxide only', 'Water vapor'],
        correct: 'Sulfur and nitrogen oxides',
      ...
      // Medium Questions
      {
        ...
        options: ['No difference', 'DNA: double-strand, deoxyribose; RNA: single-strand, ribose', 'Only size differs', 'Only location differs'],
        correct: 'DNA: double-strand, deoxyribose; RNA: single-strand, ribose',
        explanation: 'DNA is double-stranded with deoxyribose; RNA is single-stranded with ribose.',
        difficulty: 'medium'
      },
      {
        id: 'g12_biochem_med_2',
        question: 'What is cellular respiration?',
        options: ['Photosynthesis', 'Breaking down glucose to release energy', 'DNA replication', 'Protein folding'],
        correct: 'Breaking down glucose to release energy',
        explanation: 'Cellular respiration breaks down glucose to release ATP energy.',
        difficulty: 'medium'
      },
      {
        id: 'g12_biochem_med_3',
        question: 'What causes ozone depletion?',
        options: ['Carbon dioxide', 'Chlorofluorocarbons (CFCs)', 'Oxygen', 'Water vapor'],
      ...
      // Hard Questions
      {
        ...
        options: ['6CO₂ + 6H₂O → C₆H₁₂O₆ + 6O₂', 'C₆H₁₂O₆ → 6CO₂ + 6H₂O', 'ATP → ADP + P', 'DNA → RNA'],
        correct: '6CO₂ + 6H₂O → C₆H₁₂O₆ + 6O₂',
        explanation: 'Photosynthesis: 6CO₂ + 6H₂O + light energy → C₆H₁₂O₆ + 6O₂',
        difficulty: 'hard'
      },
      {
        id: 'g12_biochem_hard_2',
        question: 'What is the mechanism of enzyme action?',
        options: ['Random collision', 'Lock and key / induced fit model', 'Simple mixing', 'Temperature increase only'],
        correct: 'Lock and key / induced fit model',
        explanation: 'Enzymes work through specific binding of substrates to active sites.',
        difficulty: 'hard'
      }
    ]
  },
